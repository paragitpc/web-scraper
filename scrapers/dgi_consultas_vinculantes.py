...
from core.http_client import make_async_client, fetch, polite_sleep
from core.storage import LocalStorage, sha256_text


SOURCE = "dgi_consultas_vinculantes"
LISTING_URL = "https://www.impo.com.uy/bases/consultas-dgi-vinculantes"
DETAIL_PREFIX = "/bases/consultas-dgi-vinculantes/"
MIN_BODY_TEXT = 200
...
async def process_url(client, url: str, storage: LocalStorage, already_done: set[str]) -> str:
...
def main() -> None:
    parser = base_parser("Scraper DGI Consultas Vinculantes (via IMPO)")
